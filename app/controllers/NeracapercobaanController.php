...
class NeracapercobaanController extends \BaseController {
	...
	{
		$data = DB::table('v_neraca_percobaan');
		return View::make('accounting.laporan.neracapercobaan.list')->with('data',$data)
			->with('page','Neraca Percobaan')->with('modul','Index');
	}
