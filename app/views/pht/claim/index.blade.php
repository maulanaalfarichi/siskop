...
<a class="btn btn-primary btn-sm" href="{{ URL::to('claim/create') }}">Create New</a>
<a class="btn btn-default btn-sm pull-right" href="{{ URL::to('panduanclaim') }}">Panduan Pengajuan Pembayaran Manfaat</a><br><br>
